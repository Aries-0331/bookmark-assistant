...
function main() {
  ...
  try {
    ...
    if (
      extensionCoreResult !==
      'function,function,function,function,function,true,example.com/docs/,reading_list,READ,reading-1,current_page,sync-1,https://example.com/page?a=1&b=2'
    ) {
      fail(
        `Expected extension-core runtime helpers, content helpers, reading list helpers, fingerprint metadata, and URL normalization to be available, got ${extensionCoreResult}`
      );
    }
