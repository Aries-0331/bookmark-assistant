        ...
        <div className="max-w-3xl mx-auto p-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">{t('need_help')}</div>
                <div className="text-xs text-gray-500">{t('contact_support')}</div>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">{t('faq_guide')}</div>
                <div className="text-xs text-gray-500">{t('common_questions')}</div>
              </div>
            </button>
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-200 bg-gray-50">
              ...
              <div>
                <div className="text-sm font-medium text-gray-900">{t('version_label')}</div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-4 border-t border-gray-200">
            <div className="text-xs text-gray-500">{t('footer_copyright')}</div>
